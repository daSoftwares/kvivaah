<div class="row">
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="<?php echo $this->webroot;?>images/ganesh.gif" style="width:750px; height:380px;" alt="First slide">
                    ...
                    <div class="item">
                        <img src="<?php echo $this->webroot;?>images/shubh-vivaah.jpg"  style="width:750px; height:380px;" alt="Second slide">
                        <!--<div class="carousel-caption">
                            <h3>
                                Second slide</h3>
                            <p>
                    ...
                    <div class="item">
                        <img   style="width:750px; height:380px;" src="<?php echo $this->webroot;?>images/gatbandan.jpg" alt="Third slide">
                        <!--<div class="carousel-caption">
                            <h3>
                                Third slide</h3>
                            <p>
    ...
    <div class="row clearfix"> 
            <div class="col-md-12 "> <div class="panel panel-primary">
                <div class="panel-heading"> <h3 class="panel-title">Why Registered with Us???</h3></div>
                <div class="panel-body">
                    <div class="row">
                    
                    <div class="col-md-4"> 
                    <div class="thumbnail">
                    <img src="<?php echo $this->webroot;?>images/simple.png" width="100" height="100" class="img-responsive img-circle" alt="300x200">
                    <div class="caption"> 
                    <h3> Its Simple </h3> <p> Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit. </p> 
                    <p align="center"> <a href="<?php echo $this->webroot.PAGE_REGISTER;?>" class="btn btn-primary">Register Now</a></p> 
                    </div> 
                    </div>
                    </div>
                    ...
                    <div class="col-md-4">
                    <div class="thumbnail"> 
                    <img src="<?php echo $this->webroot;?>images/secure.png"  width="100" height="100" class="img-responsive img-circle" alt="300x200">
                    <div class="caption">
                    <h3> Its Secure </h3>
                    ...
                    <div class="col-md-4">
                    <div class="thumbnail"> 
                    <img src="<?php echo $this->webroot;?>images/free.png"  width="100" height="100" class="img-responsive img-circle" alt="300x200">
                    <div class="caption">
                    <h3> Its Free </h3> <p> Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit. </p> 
                    <p align="center"> <a href="<?php echo $this->webroot.PAGE_REGISTER;?>" class="btn btn-primary">Register Now</a> </p>
                    </div>
                    </div>
                    </div>
